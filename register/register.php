...
if(isset($_POST['submit']))
{
	...
	if($email1 == $email2)
	{
		if($pass1 == $pass2)
		{
			...
			{
			echo "<script>alert('Sorry,user existed') </script>";

			}else{
				mysql_query ("INSERT INTO `users` (`name`, `lname`, `uname`, `email`, `pass`) VALUES ( '$name', '$lname', '$uname', '$email1', '$pass1')");

			header("Location: ../register/thankslogin.php");
		}
		}
		else
		{
