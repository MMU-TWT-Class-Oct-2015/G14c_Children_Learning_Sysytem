...
<head>
		...
		setTimeout(function(){ location.replace("dragfruit7.php");; }, 3000);
}
...
<table id="dndbody">
  ...
  <td colspan="3"><div id="answer" ondrop="return dropComplete(event)" ondragover="return allowDropStatus(event)" style="text-align:center;"><a style="border: 2px solid #36b0b6;border-radius: 5px;"><strong>LIGHT RED FRUIT</strong></a></div></td>
