...
<head>
		...
		setTimeout(function(){ location.replace("draganddrop3.php");; }, 3000);
}
...
<table id="dndbody">
  <tr>
    <td><div id="div1"><img src="..\play\image\fruit3.jpg" draggable="true" ondragstart="return dragInitialize(event)" width="200px" height="150px"id="drag3"></div></td>
		<td><div id="div1"><img src="..\play\image\logo2.png" draggable="true" ondragstart="return dragInitialize(event)" width="200px" height="150px" id="drag1"></div></td>
